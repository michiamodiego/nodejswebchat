...
function CloseMessageProcessorDelegate(chatService, chatModel, data) {
	
	chatModel.setChatting(false);
	
	chatModel.addMessage("Il server è spento");
